---
title: "Creator economics, network effects and a decentralised future"
pubDate: "2022-01-03T11:01:17.288Z"
...
![Photo by Nataliya Vaitkevich from Pexels](/images/creator-economics-network-effects-and-a-decentralised-future-img-1.jpeg)
...
So powerful in fact, that it could potentially [topple a government](https://foreignpolicy.com/2021/12/11/bitcoin-ethereum-cryptocurrency-web3-great-protocol-politics/), [swing an election](https://www.theatlantic.com/technology/archive/2017/10/what-facebook-did/542502/), [lead to loss of life](https://www.reuters.com/article/us-facebook-india-whatsapp-fake-news-idUSKBN1JL0OW) and create various other loops of unthought-through consequences.
...
![](/images/creator-economics-network-effects-and-a-decentralised-future-img-2.png)
...
**Firstly**, **Twitter’s decision to censor a New York Post** story that implicated Joe Biden as corrupt. The whole episode has been described by Mike Solana very well in his [Substack article on Twitter's censorship](https://bariweiss.substack.com/p/twitter-is-about-to-get-way-worse) but to in short, Twitter chose sides, unilaterally decided this story was unfounded and needs to be contained and went ahead and took measures preventing the spread of this story (to date the story hasn’t proved to be inaccurate).
...
![](/images/creator-economics-network-effects-and-a-decentralised-future-img-3.png)
*https://twitter.com/jack/status/1316528193621327876?s=20*

He’s since moved on from Twitter while they continue investing to build a decentralised social media protocol with [BlueSky](https://blueskyweb.org/) that Twitter itself wants to be the first customer of.

**Secondly**, is a much older example from 2015 where one of the first moves Alexis Ohanian put into motion (as the former co-founder and CEO of the backpage of the internet returned as Chairman) was to ban [non-consensual nudes](https://www.bizjournals.com/newyork/news/2015/05/06/alexis-ohanian-revenge-porn-fappening-reddit.html), a decision which the previous CEO opposed in the spirit of free-speech that Reddit had always been an advocate of. It’s debatable how effective the move has been but showed bold-decision making in action.
...
![](/images/creator-economics-network-effects-and-a-decentralised-future-img-4.png)
...
Bill Gates — a pioneer of what the modern internet is today, knew of this back in 1996 ([Li Jin wrote a great piece about this recently](https://every.mirror.xyz/y_WLA-Tk3VF5uPqHi-glDLVVfHxLUbjXakRI7SMISas)).
...
![](/images/creator-economics-network-effects-and-a-decentralised-future-img-5.png)
...
Sticking to familiar terminology — assume TikTok, YouTube and Substack are all creator-focussed platforms built on a blockchain optimised for social media use cases ([like DeSo](https://www.deso.org/) for example). What happens then?
...
*If you’re unsure of some of the terms used in this article, a good pre-read could be Chris Dixon’s piece —*[Why Web3 Matters](https://future.a16z.com/why-web3-matters/)*.*

*This is the first time I am publishing something that I feel strongly about so if you like it, think it’s trash or are somewhere in between— drop a comment or*[let me know](https://twitter.com/pranaym23)*here.*


---

*Originally published on Medium. You can view the [original article on Medium](https://medium.com/cryptostars/creator-economics-network-effects-and-a-decentralised-future-498b0877df83).*
